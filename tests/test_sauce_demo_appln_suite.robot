...
Test Case 3
     ...
     [Tags]    Login and Validate the Logout Functionality
...
Test Case 5
     ...
     [Tags]    Adding A Product from Each Filter
...
Test Case 6
     ...
     [Tags]    Check the Count is Equal as Added Items
...
Test Case 7
     ...
     [Tags]    Product Verification in Cart
